...
setwd('/Users/judyyang/GitHub/smoke_alarm_models copy')
...
rc <- data.table(read.csv('/Users/judyyang/GitHub/smoke_alarm_models copy/data/HomeFire_SmokeAlarmInstalls.csv', stringsAsFactors=F))
...
acs <- fread('/Users/judyyang/GitHub/smoke_alarm_models copy/data/Census/acs.csv', stringsAsFactors=F)
...
write.table(acsCT_c[, .(risk_1a, state, cnty, tract, geoid2)], file='/Users/judyyang/GitHub/smoke_alarm_models copy/model_1a_RC_homevisit/results/smoke-alarm-risk-scores.csv', row.names=F, sep=',')

...
|----|----------------------------------------------------------------------------|--------------------------------------------|-------|
| 1. | Double check all input files are the same as the Originals for replication | Code works, and results are seemingly close.  See phase2-results.  Not as close as one might like, however. | X |

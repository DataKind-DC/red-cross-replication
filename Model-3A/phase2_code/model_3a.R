...
modeling_injury_dataset_imp = read_csv("/Users/manueltonneau/Documents/DataKind/smoke_alarm_models-phase1/model_3a_casualty_given_fire/data/clean/modeling_injury_dataset_imp.csv")
...
write.csv(acs_injury_preds, "/Users/manueltonneau/Documents/DataKind/smoke_alarm_models-phase1/model_3a_casualty_given_fire/results/acs_tract_injury_predictions.csv",
          row.names = FALSE)
...
modeling_death_dataset_imp = read_csv("/Users/manueltonneau/Documents/DataKind/smoke_alarm_models-phase1/model_3a_casualty_given_fire/data/clean/modeling_death_dataset_imp.csv")
...
write.csv(acs_death_preds, "/Users/manueltonneau/Documents/DataKind/smoke_alarm_models-phase1/model_3a_casualty_given_fire/results/acs_tract_death_predictions.csv",
          row.names = FALSE)
...
write.csv(combined_predictions, "/Users/manueltonneau/Documents/DataKind/smoke_alarm_models-phase1/model_3a_casualty_given_fire/results/acs_tract_death_injury_risk_scores.csv",
          row.names = FALSE)
...
rf_injury <- randomForest(target ~ ., data = modeling_injury_dataset_imp[, -c(1)],
                          ntree = 250,na.action=na.exclude)
...
png("/Users/manueltonneau/Documents/DataKind/smoke_alarm_models-phase1/model_3a_casualty_given_fire/results/model_3a_rf_injury_imp_plot.png", width = 1200, height = 900)
...
write.csv(acs_injury_preds, "/Users/manueltonneau/Documents/DataKind/smoke_alarm_models-phase1/model_3a_casualty_given_fire/results/acs_tract_injury_rf_predictions.csv",
          row.names = FALSE)
...
png("/Users/manueltonneau/Documents/DataKind/smoke_alarm_models-phase1/model_3a_casualty_given_fire/results/model_3a_rf_death_imp_plot.png", width = 1200, height = 900)
...
write.csv(acs_death_preds, "/Users/manueltonneau/Documents/DataKind/smoke_alarm_models-phase1/model_3a_casualty_given_fire/results/acs_tract_death_rf_predictions.csv",
          row.names = FALSE)
...
write.csv(combined_predictions_rf, "/Users/manueltonneau/Documents/DataKind/smoke_alarm_models-phase1/model_3a_casualty_given_fire/results/acs_tract_death_injury_rf_risk_scores.csv",
          row.names = FALSE)

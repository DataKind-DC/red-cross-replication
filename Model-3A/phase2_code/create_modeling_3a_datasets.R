...
downloads_path = '/Users/manueltonneau/Documents/DataKind/smoke_alarm_models-phase1/model_3a_casualty_given_fire/data/'
...
for(year in years) {
  ...
  ### Save cleaned data
  save(nfirs_outcomes_geo_clean, file = paste0("/Users/manueltonneau/Documents/DataKind/smoke_alarm_models-phase1/model_3a_casualty_given_fire/data/clean/nfirs_outcomes_geo_clean_", year, ".Rdata"))
...
load("/Users/manueltonneau/Documents/DataKind/smoke_alarm_models-phase1/model_3a_casualty_given_fire/data/clean/nfirs_outcomes_geo_clean_2009.Rdata")
nfirs_outcomes_geo_clean_2009 = nfirs_outcomes_geo_clean

rm("nfirs_outcomes_geo_clean")

load("/Users/manueltonneau/Documents/DataKind/smoke_alarm_models-phase1/model_3a_casualty_given_fire/data/clean/nfirs_outcomes_geo_clean_2010.Rdata")
nfirs_outcomes_geo_clean_2010 = nfirs_outcomes_geo_clean

rm("nfirs_outcomes_geo_clean")

load("/Users/manueltonneau/Documents/DataKind/smoke_alarm_models-phase1/model_3a_casualty_given_fire/data/clean/nfirs_outcomes_geo_clean_2011.Rdata")
...
load("/Users/manueltonneau/Documents/DataKind/smoke_alarm_models-phase1/model_3a_casualty_given_fire/data/clean/nfirs_outcomes_geo_clean_2012.Rdata")
...
load("/Users/manueltonneau/Documents/DataKind/smoke_alarm_models-phase1/model_3a_casualty_given_fire/data/clean/nfirs_outcomes_geo_clean_2013.Rdata")
...
save(nfirs_outcomes_geo_clean_multi_year, file = "/Users/manueltonneau/Documents/DataKind/smoke_alarm_models-phase1/model_3a_casualty_given_fire/data/clean/nfirs_outcomes_geo_clean_multi_year.Rdata")
...
rm(list=ls())
load("/Users/manueltonneau/Documents/DataKind/smoke_alarm_models-phase1/model_3a_casualty_given_fire/data/clean/nfirs_outcomes_geo_clean_multi_year.Rdata")
...
source("/Users/manueltonneau/Documents/DataKind/smoke_alarm_models-phase1/model_3a_casualty_given_fire/code/general_purpose/unbalanced_downsample.r")
...
acs_tract_data = read_csv("/Users/manueltonneau/Documents/DataKind/smoke_alarm_models-phase1/model_3a_casualty_given_fire/data/acs_tract_data.csv")
...
write.csv(modeling_death_dataset_imp, "/Users/manueltonneau/Documents/DataKind/smoke_alarm_models-phase1/model_3a_casualty_given_fire/data/clean/modeling_death_dataset_imp.csv",
          row.names = FALSE)
...
write.csv(modeling_injury_dataset_imp, "/Users/manueltonneau/Documents/DataKind/smoke_alarm_models-phase1/model_3a_casualty_given_fire/data/clean/modeling_injury_dataset_imp.csv",
          row.names = FALSE)
